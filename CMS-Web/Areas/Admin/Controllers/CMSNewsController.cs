    ...
    public class CMSNewsController : Controller
    {
        ...
        public ActionResult Edit(CMS_NewsModels model)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(model.ImageURL))
                {
                    model.ImageURL = model.ImageURL.Replace(Commons._PublicImages +"News/", "").Replace(Commons.Image770_395, "");
                }
                ...
                if (result)
                {
                    if (!string.IsNullOrEmpty(model.ImageURL) && model.PictureByte != null)
                    {
                        ...
                        {
                            temp = temp.Replace(Commons._PublicImages + "News/", "").Replace(Commons.Image770_395, "");
